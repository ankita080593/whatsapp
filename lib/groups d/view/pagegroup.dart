...
import 'package:whattsup/Mywidget/Mobile/groups.dart';
import 'package:whattsup/enum/enum12.dart';

import '../../Model/GroupContactModel.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    cursorHeight: 30,
                    decoration:
                        InputDecoration(hintText: 'Type group subject here...'),
                  ),
                ),
                SizedBox(
                    width: 50,
          ...
          SizedBox(width:350,child: Text('${widget.group.length} members')),
          Container(
            height: 100,
            width: 500,
            //color: Colors.red,
